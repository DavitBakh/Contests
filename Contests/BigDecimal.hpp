...
/*
    BigDecimal from input stream
    ------------------------
*/

std::istream& operator>>(std::istream& in, BigDecimal& num) 
{
    std::string input;
    in >> input;
    num = BigDecimal(input);  // remove sign from value and set sign, if exists
...
/*
    BigDecimal to output stream
    -----------------------
*/

std::ostream& operator<<(std::ostream& out, const BigDecimal& num) 
{
    out << num.value;
